...
<i>"How did the game go?"</i>   
<i>"There were three players: me, Jennifer and Samantha. Samantha went first playing the word 'again' for 7 points. ... Jennifer ended up winning with 297 points."</i>  
...
Writing the english will also allow you to write 3-4 lines at once, which will also serves as bookmarks for what still needs to be done. Once the code is written, you can delete the English. It is merely a stepping stone to write from intention.
...
A lot of times programmers are so used to thinking in code, that you have to remind them to think in English. Here is an example I've seen a lot.
